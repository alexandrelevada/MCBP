...
Python script to reproduce the first set of experiments in the paper
...
sc2 = silhouette_score(filtered, kmeans.labels_)
ch2 = calinski_harabasz_score(filtered, kmeans.labels_)
db2 = davies_bouldin_score(filtered, kmeans.labels_)
print('K-means++ on filtered data')
print('SC: ', sc2)
print('CH: ', ch2)
print('DB: ', db2)

#print()
#print(str(sc1)+'\t'+str(ch1)+'\t'+str(db1)+'\t'+str(sc2)+'\t'+str(ch2)+'\t'+str(db2))
