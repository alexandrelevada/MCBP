...
Python script to reproduce the third set of experiments in the paper
...
sc2 = silhouette_score(filtered, hdbscan.labels_)
ch2 = calinski_harabasz_score(filtered, hdbscan.labels_)
db2 = davies_bouldin_score(filtered, hdbscan.labels_)
print('Filtered data')
print('SC: ', sc2)
print('CH: ', ch2)
print('DB: ', db2)
